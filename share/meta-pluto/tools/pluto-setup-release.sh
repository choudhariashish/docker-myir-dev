...
. sources/meta-pluto/tools/setup-utils.sh
...
cp sources/meta-pluto/EULA.txt sources/meta-freescale/EULA
...
META_FSL_BSP_RELEASE="${CWD}/sources/meta-pluto/meta-bsp"

echo "" >> $BUILD_DIR/conf/bblayers.conf
echo "# i.MX Yocto Project Release layers" >> $BUILD_DIR/conf/bblayers.conf
hook_in_layer meta-pluto/meta-bsp
hook_in_layer meta-pluto/meta-sdk
hook_in_layer meta-pluto/meta-ml
